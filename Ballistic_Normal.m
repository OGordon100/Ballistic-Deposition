...
for rep = 1:repeats
    ...
    FigHandle1.Name=['Ballistic Normal, Rep = ',num2str(rep)];
   ...
   %image(activelattice(:,2:end-1)+1)
    ...
    % Watch in realtime - uncomment these lines & comment out line 133
   %drawnow               % Uncomment to get all graphs/plot in realtime
   %map = [0,0,0;1,0,0;1,1,0;];
   %colormap(map);
   %end                   % Uncomment+comment line 133 to watch in realtime                 % Uncomment+comment line 146 to watch in realtime
